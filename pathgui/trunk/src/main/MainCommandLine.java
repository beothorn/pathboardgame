...
public class MainCommandLine implements PhaseChangeListener{
	...
	public MainCommandLine(final String[] args) throws IOException {
		game = new Game();
		game.addPhaseChangeListener(this);
		addAIPlayers();
	...
	public void play(final String line){
		...
		} catch (final InvalidPlayStringException i) {
		...
		}catch(final InvalidPlayException i){
			System.out.println(i.getMessage());
			return;
		}
